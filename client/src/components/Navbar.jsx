...
const Navbar = () => {
  ...
  return (
    <div
      className={`flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-4 font-semibold text-gray-600 border-b border-borderColor relative transition-all ${
