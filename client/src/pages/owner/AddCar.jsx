      ...
      <form onSubmit={onSubmitHandler} className='flex flex-col gap-5 text-gray-500 text-sm mt-6 max-w-xl'>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6'>
          ...
          <div className='flex flex-col w-full'>
            ...
            <input type="text" placeholder='4' required className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none' value={car.seating_capacity} onChange={e => setCar({...car, seating_capacity: e.target.value})} />
          </div>
        </div>
        ...
        <div className='flex flex-col w-full'>
          ...
          <textarea placeholder='e.g. A luxurious SUV with a spacious interior and a powerfull engine.' required onChange={e => setCar({...car, description: e.target.value})} value={car.description} className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none'></textarea>
